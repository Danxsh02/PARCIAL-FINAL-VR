...
public class TrashChuteTrigger : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Bolsa") && bolsaActual == null)
        {
            ...
            // Detener las coroutines que puedan estar corriendo
            ...
            // Desactiva el componente ResiduoClasificable para evitar destrucción automática
            ...
            {
                Debug.LogWarning("No se encontró el componente de ResiduoClasificable en la bolsa");
            }
            ...
            Debug.Log("Se configuró la bolsa correctamente en el Chute");
        }
    ...
    private void Update()
    {
        if (bolsaActual != null && bolsaEnContacto)
        {
            ...
            if (bolsaActual == null)
            {
                Debug.LogError("LA BOLSA SE DESTRUYÓ!");
